...
fn merge_worker_sources(world: &mut World, parent: Entity, worker: Entity, item_id: &str) {
    ...
    let tokens = leviath_core::estimate_tokens(&block);
    ...
    let _ = window.add_to_region(SOURCES_REGION, block, tokens);
}
